/*
  ...
  1. Changes
    ...
    - Add proper RLS policies for projects and shared_projects tables
...
DROP POLICY IF EXISTS "Users can read public and shared projects" ON projects;
...
-- Drop existing shared_projects policies
